...
<link href="css/collegekhojamnastyle.css" rel="stylesheet">
    <script language="javascript">
     function function1(id) {
      ...
      window.location.href = "http://localhost/CollegeKhojamna/career_view.php?id=" + id;
    }
      </script>
</head>
<body>
  ...
  <div class="container">
	...
	<div class="row no_padding nothing">
      ...
      <div class="col-md-7">
        ...
        <p>The salary depends on the discipline and communications skills of applicants. However, salaries of most of the professionals in these fields start at NPR 40,000 per month.</p>
	...
	<div class="row no_padding nothing">
      ...
      <div class="col-md-7">
        ...
        <hr>
        <p>Commercial pilots and air hostess are dream job profile for many. However, due to the limited requirement of such roles, you will find intense competition in this field. Commercial pilots get a starting salary of NPR 1,50,000+ per month while Air Hostesses get NPR 50,000+ per month.</p>
        <p><a href="#" role="button" class="btn btn-primary" style="margin-top:10px">Learn more</a></p>
      </div>
    </div>
	...
	<div class="row no_padding nothing">
      ...
      <div class="col-md-7">
        ...
        <hr>
        <p>In Nepal, education is considered to be a noble and prestigious profession. While education sector attracts everyone equally, females seem to be more inclined towards this profession. To develop a formal career in teaching in schools, you need to complete B.Ed./Teachers’ Training program.</p>
        <p>The salary in the education sector can vary from NPR 15,000 to 1,00,000 lakh depending on your education credentials and field.</p>
    ...
    <div class="row no_padding nothing">
      ...
      <div class="col-md-7">
        ...
        <hr>
        <p>The Internet is all about content. From news to social media to youtube videos, there is a writer behind everything you see on net. The content may be written in the form or news, social media post for business pages, video script, blog, website content, product description, brochure, advertising copy, user guides or business agreement. All companies be it small or large need professional writers for their content development requirement. Writers are paid handsomely for their good work. You can write in English, Nepali or any other regional languages you are good in. The salary of full time content writer can be anything from NPR 15,000-35,000 per month.</p>
        <p><a href="#" role="button" class="btn btn-primary" style="margin-top:10px">Learn more</a></p>
      </div>
    </div>
